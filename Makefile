...
# Project:  MyForm.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile MyForm.pro
#############################################################################
...
DISTDIR = /media/andres69/Facultad/projecte-hackUPC/.tmp/MyForm1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: MyForm.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cc MyForm.cc $(DISTDIR)/
...
moc_MyForm.cpp: MyForm.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /media/andres69/Facultad/projecte-hackUPC/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/media/andres69/Facultad/projecte-hackUPC -I/media/andres69/Facultad/projecte-hackUPC -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include MyForm.h -o moc_MyForm.cpp
...
main.o: main.cc MyForm.h \
		ui_MyForm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cc

MyForm.o: MyForm.cc MyForm.h \
		ui_MyForm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyForm.o MyForm.cc
